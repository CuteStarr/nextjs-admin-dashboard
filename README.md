...
<p>
    Next.js Typescript Dashboard is built using the latest industry standards and features a clean and premium design style, making use of colors and accents to improve the user experience for all included flows and pages.
</p>
<p>
...
<ol>
    ...
    <li>Clone repository: <code>git clone https://github.com/softwaredeveloper-Lucas/nextjs-admin-dashboard.git</code></li>
